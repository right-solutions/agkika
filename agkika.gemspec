...
require "agkika/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "agkika"
  s.version     = Agkika::VERSION
  s.authors     = ["kpvarma"]
  s.email       = ["krshnaprsad@gmail.com"]
  s.homepage    = "https://github.com/right-solutions/agkika"
  ...
  s.summary     = "Agkika is a simple accounting system which is mountable into a rails application."
  s.description = "Comes with builtin interfaces for Estimation, Invoices, Payments, Receipts, Ledgers & Journals"
